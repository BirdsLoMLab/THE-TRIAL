...
After each narration, include a scene block in this exact format (the app will parse it to update visuals):
[SCENE]
speaker: <name of who is currently speaking or "narrator">
mood: <one of: tense, dramatic, calm, angry, fearful, confident, suspicious, shocked, sad, neutral>
location: <one of: courtroom_wide, witness_stand, judge_bench, evidence_table, jury_box, gallery>
evidence: <if evidence is being examined, its short name; otherwise "none">
characters_present: <comma-separated list of character names visible in the current moment>
[/SCENE]
...
- End with a [VERDICT_RESULT] block:
[VERDICT_RESULT]
